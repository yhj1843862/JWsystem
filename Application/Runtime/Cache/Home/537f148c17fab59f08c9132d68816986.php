...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">院系介绍：</label>
            <div class="formControls col-xs-4 col-sm-5">
                <textarea class="textarea" id="remark"  placeholder="院系的介绍...10-255个字符" onKeyUp="countStringLength(this,10,255)"></textarea>
...
<script>
    $(function () {
        ...
        $('#subBtn').click(function () {
            ...
            {
                errorAlert('院系介绍需要10-255个字符');
                return false;
            }

            $.post('', {n:number, name: name, r:remark}, function (e) {
                console.log(e);
                if(e.status)
                {
                    successAlert(e.info);
