...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a class="btn btn-primary" title="添加顶级地区" data-href="<?php echo U('Home/Area/add');?>" onclick="openPage(this)" href="javascript:;">
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            <?php if(is_array($area_list)): $i = 0; $__LIST__ = $area_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
                ...
                <td class="f-14 td-manage">
                    ...
                    <!--<a class="ml-5" onClick="article_edit('资讯编辑','article-add.html','10001')" href="javascript:;" title="编辑">-->
                        <!--<i class="Hui-iconfont">&#xe6df;</i>-->
                    <!--</a>-->
                    <!--<a class="ml-5" onClick="article_del(this,'10001')" href="javascript:;" title="删除">-->
                        <!--<i class="Hui-iconfont">&#xe6e2;</i>-->
                    <!--</a>-->
                </td>
