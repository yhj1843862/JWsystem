            ...
            <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
                    ...
                    <td>
                        <a onClick="openPage(this)" data-width="1200"
                           data-href="<?php echo U('Home/Class/subject_list',['id'=>$v['class_id']]);?>" href="javascript:;"
                           title="学科列表 （<?php echo ($v["class_name"]); ?>）">
                            <i class="Hui-iconfont Hui-iconfont-fenlei"></i>
                        </a>
                    </td>
                    <td>
                        <a onClick="openPage(this)" data-width="1200" data-height="500"
                           data-href="<?php echo U('Home/Class/class_student_list',['id'=>$v['class_id']]);?>" href="javascript:;"
                           title="学生列表 （<?php echo ($v["class_name"]); ?>）">
                            <i class="Hui-iconfont Hui-iconfont-list"></i>
                        </a>
                        <a onClick="openPage(this)" data-width="1200" data-height="600"
                           data-href="<?php echo U('Home/User/import_student',['id'=>$v['class_id']]);?>" href="javascript:;"
                           title="导入学生信息 （<?php echo ($v["class_name"]); ?>）">
