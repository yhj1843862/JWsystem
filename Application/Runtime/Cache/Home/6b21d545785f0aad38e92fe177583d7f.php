    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
                    ...
                    <td>
                        <a onClick="openPage(this)" data-height="400"
                           data-href="<?php echo U('Home/Class/add',['id'=>$v['profession_id']]);?>" href="javascript:;"
                           title="添加班级（<?php echo ($v["department_name"]); ?>/<?php echo ($v["profession_name"]); ?>）">
                            <i class="Hui-iconfont Hui-iconfont-add"></i>
                        </a>
                    </td>
                    <td>
                        <a data-href="<?php echo U('Home/Class/class_list',['id'=>$v['profession_id']]);?>"
                           data-title="班级列表（<?php echo ($v["department_name"]); ?>/<?php echo ($v["profession_name"]); ?>）" onClick="Hui_admin_tab(this,2)"><i
                                class="Hui-iconfont Hui-iconfont-list"></i></a>
                    </td>
                    <td>
                        <a data-href="<?php echo U('Home/Profession/set_subject',['id'=>$v['profession_id']]);?>"
                           title="学科配置（<?php echo ($v["department_name"]); ?>/<?php echo ($v["profession_name"]); ?>）" data-width="1000"
                           onClick="openPage(this)"><i class="Hui-iconfont Hui-iconfont-system"></i></a>
                    </td>
