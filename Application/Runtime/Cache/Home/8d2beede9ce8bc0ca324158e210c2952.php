...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a class="btn btn-primary" title="添加用户" data-width="1200" data-href="<?php echo U('Home/User/add');?>"
               onclick="openPage(this)" href="javascript:;">
                <i class="Hui-iconfont Hui-iconfont-add"></i> 添加用户
            </a>

            <a class="btn btn-success" title="添加学生" data-width="1200" data-href="<?php echo U('Home/User/add_student');?>"
               onclick="openPage(this)" href="javascript:;">
